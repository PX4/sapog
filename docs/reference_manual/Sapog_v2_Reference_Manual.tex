...
\CfgParamIndexEntry{mot+pwm+dt+ns}{nanosecond}{boot}{400}{800}{600}{PWM dead time}
...
\CfgParamIndexEntry{mot+i+shunt+mr}{milliohm}{boot}{0.1}{100}{5}{Resistance of the current measurement shunt}
...
\CfgParamIndexEntry{uavcan+node+id}{}{boot}{0}{125}{0}{Node ID, zero for dynamic alloc.}
