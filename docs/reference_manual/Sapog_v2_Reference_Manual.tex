...
Enumeration request will return error \verb|ERROR_INVALID_MODE| if the motor is not stopped.
...
\begin{ZubaxSimpleTable}{UAVCAN subscribed messages}{|l|X|}
    ...
    \texttt{uavcan.equipment.indication.BeepCommand}       & Ignored if running. \\
...
\begin{ZubaxSimpleTable}{UAVCAN provided services}{|l|X|}
    ...
    \texttt{uavcan.protocol.enumeration.Begin}             & Ignored if running. \\
