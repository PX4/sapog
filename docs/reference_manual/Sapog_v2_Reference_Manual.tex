...
and/or the maximum commutation period should be shortened.
The minimum voltage limit does not apply to RPM loop mode,
where the minimum speed is governed by a dedicated configuration parameter.
...
look-ahead extrapolation, so that the regression problem will be applied to the sample set acquired
